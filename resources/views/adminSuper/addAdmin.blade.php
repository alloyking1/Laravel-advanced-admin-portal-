            ...
            <div class="container-fluid">
                <div class="">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">{{ __('Add Area Admin') }}</div>

                                <div class="card-body">
                                    <form method="POST" action="/adminSuper/area/admin/save">
                                        @csrf
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="dob" type="date" class="form-control{{ $errors->has('dob') ? ' is-invalid' : '' }}" name="dob">
